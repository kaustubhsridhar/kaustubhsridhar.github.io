...
I am interested in creating adaptive generalist AI agents for the physical and digital worlds. In the physical world, I work on scaling world models and vision-language action models. In the digital world, my focus is on developing AI that continuously learns.
...
<div style="display: flex; flex-wrap: wrap; gap: 20px; align-items: center; margin-top: 10px; margin-bottom: 15px;">
  ...
  <a href="https://www.technologyreview.com/2025/11/13/1127921/google-deepmind-is-using-gemini-to-train-agents-inside-goat-simulator-3/" target="_blank">
    <img style="border:solid;" src="assets/logos/mit_tech_review.png" height="60" alt="MIT Tech Review">
  </a>
  <a href="https://techcrunch.com/2025/11/13/googles-sima-2-agent-uses-gemini-to-reason-and-act-in-virtual-worlds/" target="_blank">
    <img style="border:solid;" src="assets/logos/techcrunch.png" height="60" alt="TechCrunch">
  </a>
</div>
Additional Coverage: 
